...
public class AssignServiceTest {
    ...
    public void assign() {
        ...
        Customer customer2 = new Customer("C2", "고객#2", "19911001", "M");
        Customer customer3 = new Customer("C3", "고객#3", "19911001", "M");
        Customer customer4 = new Customer("C4", "고객#4", "19911001", "W");
        Customer customer5 = new Customer("C5", "고객#5", "19911001", "m");
        ...
        List<Customer> filteredCustomers = assignService.assign(customers, surveyors);
        for (Customer customer : filteredCustomers) {
            System.out.println(customer.getName() + "(" + assignService.calculateAge(customer) + "): " + customer.getSurveyorId());
        }

        assertEquals("S2", filteredCustomers.get(1).getSurveyorId());
    }
